...
export const putDailyworkData = async(employeeId, userType, currentDateNew, putDataReqBody)=>{
    console.log("running put reusable");
    try {
        const putResp = await axios.put(`${API_BASE_URL}/update-daily-work/${employeeId}/${userType}/${currentDateNew}`,putDataReqBody);
       return putResp.data;
    } catch (error) {
        console.log(error);
    }
