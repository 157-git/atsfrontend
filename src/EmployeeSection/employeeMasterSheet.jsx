...
const fetchData = async (page, size) => {
  ...
  try {
    ...
    if (userType === "SuperUser") {
      // ✅ SuperUser API
      url = `${API_BASE_URL}/superuser/master-sheet?superUserId=${employeeId}&searchTerm=${searchTerm}&page=${page}&size=${size}`;
    } else {
      // ✅ Existing flow (DO NOT TOUCH)
      url = `${API_BASE_URL}/master-sheet/${employeeId}/${userType}?searchTerm=${searchTerm}&page=${page}&size=${size}`;
    }
                  ...
                  <table className="attendance-table">
                    <thead>
                      <tr className="attendancerows-head">
                        {!showShareButton && (userType === "TeamLeader" || userType === "Manager" || userType === "Recruiters") && (
