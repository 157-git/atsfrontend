          ...
          <div className="main-description-share2">
            <div className="job-posting" id="shareEMD">
              ...
              <div className="details">
                ...
                {/* <br /> */}
                <p className="salary">Salary upto {data.salary}</p>
                <p>
                   {data.jobType} 
                </p>
                <p>
                <i class="fa-solid fa-location-dot"></i> {" "} {data.detailAddress}
                </p>
                ...
                <div className="contact">
                  ...
                  <img src={profileImage} alt="Profile Image" />
                    ...
                    <p>Contact: {data.officialContactNo}</p>
                    <p>
                      Email:{" "}
                      <a href="mailto:bezalwar@157ipl.com">
                        {data.officialMail}
                      </a>{" "}
                    </p>
                  </div>
