    ...
    setFormData((prevData) => {
      ...
      if (name === "lineUp.holdingAnyOffer") {
        ...
        if (name.startsWith("lineUp.certificates")) {
          // Split the name to handle nested fields (e.g., "lineUp.certificates[0].certificateName")
          const nameParts = name.split(".");
          const index = parseInt(nameParts[1].match(/\d+/)[0], 10); // Extract index from "certificates[0]"
          const field = nameParts[2]; // Get the field name (e.g., "certificateName" or "certificateFile")

          const updatedCertificates = [...prevData.lineUp.certificates];
          updatedCertificates[index][field] = inputValue; // Update the specific field for the certificate
          ...
          const nestedField = nameParts[1]; // e.g., lineUp.someField
          updatedData.lineUp = {
            ...prevData.lineUp,
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        updatedFormData.lineUp.certificates[index].certificateFile =
          reader.result.split(",")[1]; // Only keep base64 part
          ...
          <div className="form-grid-December">
            <div className="form-column-December">
              <div className="form-group-December">
                <label>Full name <span className="setRequiredAstricColorRed">*</span></label>
              ...
              <div className="form-group-December">
                <label>Contact number <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faPhone}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <label>Email address <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faMailBulk}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <label>Current salary (LPA) <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faSackDollar}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <label>Expected salary (LPA) <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faMoneyCheck}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <label>Job designation <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faUserTie}
                    className="input-icon-December"
            ...
            <div className="form-column-December">
              <div className="form-group-December">
                <label>Preferred location <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faLocationPin}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <label>Notice period (Days) <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
              ...
              <div className="form-group-December">
                <label>Availability for interview <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faCalendar}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <label>Total experience <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faKeyboard}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <label>Relevant experience (Years) <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faBriefcase}
                    className="input-icon-December"
              ...
              <div className="form-group-December">
                <div className="gender">
                  <label>Gender <span className="setRequiredAstricColorRed">*</span></label>
            ...
            <div className="form-column-December">
              ...
              <div className="form-group-December">
                <label>Date of birth <span className="setRequiredAstricColorRed">*</span></label>
                <div className="input-with-icon-December">
                  <FontAwesomeIcon
                    icon={faBirthdayCake}
                    className="input-icon-December"
                      ...
                      control={
                        <Radio
                          ...
                          onChange={() => {
                            ...
                            formData.lineUp.certificates = [{ certificateName: "", certificateFile: null }]
                          }}
                        />
                      }
                      label="No"
                      ...
                      control={
                        <Radio
                          ...
                          onChange={() => {
                            ...
                            setFormData({
                              ...formData,
                              alternateNumber: "", // Reset when "Yes" is selected
                            });
                          }}
                        />
                      }
                      ...
                      control={
                        <Radio
                          ...
                          onChange={() => {
                            ...
                            setFormData({
                              ...formData,
                              alternateNumber: 0, // Set 0 when "No" is selected
                            });
                          }}
                        />
                      }
