    ...
    <div className="container newcontainerclassforinterviewform">
      ...
      <div className="form-row">
        <div className="form-group small newformgroupforinterviewquestionsform">
          ...
          <select value={indexRequirment} onChange={handleJobChange} className="newinputforinterviewquestions">
...
<option key={index} value={index}>
        ...
        <div className="form-group small newformgroupforinterviewquestionsform">
          ...
          <input type="text" value={companyName} readOnly className="newinputforinterviewquestions" />
        </div>
        <div className="form-group small newformgroupforinterviewquestionsform">
          <label>Designation:</label>
          <input type="text" value={designation} readOnly className="newinputforinterviewquestions" />
        </div>
        <div className="form-group small newformgroupforinterviewquestionsform">
          <label>Interview Round:</label>
          <select value={interviewRound} onChange={(e) => setInterviewRound(e.target.value)} className="newinputforinterviewquestions">
        ...
        <div className="form-group small newformgroupforinterviewquestionsform">
          ...
          <input value={questionAttachment ? "" : undefined}  type="file" accept=".pdf,.doc,.docx" onChange={handleFileChange} className="newinputforinterviewquestions" />
      ...
      <div className="form-row">
        <div className="form-group full-width textarea-container">
          ...
          <div className="form-group-Queations">
            ...
            <input type="text" value={question} onChange={(e) => setQuestion(e.target.value)} className="newinputforinterviewquestions" placeholder="Enter Questions" />
          </div>
          <div className="form-group-reference">
            <label>Reference:</label>
            <input type="text" value={reference} onChange={(e) => setReference(e.target.value)} className="newinputforinterviewquestions" placeholder="Enter Reference" />
          </div>
          <button onClick={handleAddQuestion} className="add-btn1 lineUp-Filter-btn">Add Question</button>
          </div>
          ...
          <table className="NEWCLASSFORTABLE">
            <thead>
              <tr className="newtableheadingrow">
                ...
                <th className="newthclassforinterviewtable">Interview Round</th>
...
<p> {ques.interviewQuestions ? ques.interviewQuestions : " "}</p>
                  ...
                  <td className="newthclassforinterviewtable" onClick={()=>handleViewAttachment(item.questionAttachment)}>{item.questionAttachment !== null ? <EyeOutlined /> : <EyeInvisibleOutlined />}</td>
                  </tr>
                  </>
                ))
              }
      ...
      {
        openAttachmentModal && (
          <Modal title="Attachment" open={openAttachmentModal} onOk={handleOk} onCancel={handleCancel} footer={null}>
        <iframe
                src={attachmentUrl}
                title="Questions"
